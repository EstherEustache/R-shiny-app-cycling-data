setwd("~/Documents/Cours_M2/projet final/projet_app_r")
library(ggthemes)
library(shiny)
library(ggplot2)
library(dplyr)
...
ui <- dashboardPage(
  dashboardHeader(title = "Cycling performance analysis -  EVA KPI"),
  dashboardSidebar(sidebarMenu(
    menuItem("Curve", tabName = "curve"),
    menuItem("EVA indicator", tabName = "eva"),
      ...
      fluidRow(
        ...
        box(width = 3,
            ...
            sliderInput(inputId = "param",
                      label = "Parametre de lissage", min = 1, max = 25,
                      value = 3)
            )
       )
      ),
